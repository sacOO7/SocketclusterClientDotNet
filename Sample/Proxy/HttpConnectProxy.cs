...
using Mysocket=System.Net.Sockets;
...
namespace Sample.Proxy
{
        ...
        public class HttpConnectProxy : ProxyConnectorBase
        {
            ...
            {
                public Mysocket.Socket Socket { get; set; }
            ...
            : base(proxyEndPoint, clientAccessPolicyProtocol)
        {
            ...
            protected override void ProcessConnect(Mysocket.Socket socket, object targetEndPoint, SocketAsyncEventArgs e)
            {
                if (e != null)
                {
